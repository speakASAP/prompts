# Copilot Instructions — `prompts-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/prompts-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/prompts.git`, branch `main`.
...
3. This repo, in order: `AGENTS.md` `AGENT_OPERATIONS.md` `TASKS.md` `STATE.json` `CLAUDE.md`
